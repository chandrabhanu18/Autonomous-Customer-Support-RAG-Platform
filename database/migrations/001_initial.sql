...
CREATE INDEX IF NOT EXISTS idx_documents_doc_id ON intellisupport.documents(doc_id);
CREATE INDEX IF NOT EXISTS idx_chunks_doc_id ON intellisupport.chunks(doc_id);
CREATE INDEX IF NOT EXISTS idx_chunks_chunk_id ON intellisupport.chunks(chunk_id);
CREATE INDEX IF NOT EXISTS idx_queries_query_id ON intellisupport.queries(query_id);
CREATE INDEX IF NOT EXISTS idx_responses_response_id ON intellisupport.responses(response_id);
CREATE INDEX IF NOT EXISTS idx_feedback_response_id ON intellisupport.feedback(response_id);
